...
class XunleiHijackDownloader(_PluginBase):
    ...
    def _build_page_metrics_poller_onerror(plugin_id: str, interval_ms: int = 1000) -> str:
        ...
        return (
            ...
            "if(content){content.style.display='inline-flex';content.style.alignItems='center';content.style.justifyContent='center';content.style.fontSize='13px';content.style.lineHeight='1';content.style.fontWeight='700';content.textContent=glyph;}"
