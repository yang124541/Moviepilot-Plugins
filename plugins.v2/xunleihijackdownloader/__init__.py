...
class XunleiHijackDownloader(_PluginBase):
                    ...
                    "content": [
                        {
                            ...
                            "content": [
                                ...
                                {
                                    "component": "VCol",
                                    "props": {"class": "py-0", "style": "flex:0 1 420px;min-width:260px;max-width:560px;margin-left:auto;"},
                                    "content": [
                                        {
                                            "component": "div",
                                            "props": {
    ...
    def _build_page_metrics_poller_onerror(plugin_id: str, interval_ms: int = 5000) -> str:
        ...
        return (
            ...
            "if(k==='success'){return '0 0 0 10px rgba(76,175,80,.45),0 0 16px rgba(76,175,80,.38)';}"
            "if(k==='warning'){return '0 0 0 10px rgba(251,140,0,.45),0 0 16px rgba(251,140,0,.38)';}"
            "if(k==='error'){return '0 0 0 10px rgba(255,82,82,.45),0 0 16px rgba(255,82,82,.38)';}"
            "return '0 0 0 10px rgba(25,118,210,.45),0 0 16px rgba(25,118,210,.38)';"
            "};"
