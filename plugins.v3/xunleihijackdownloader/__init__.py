...
# V3 does not expose the legacy DirectoryHelper. Source directory resolution
# therefore falls back to the user-configured source download directory.
                ...
                if source_root.exists() and source_root.is_dir():
                    ...
                    if not src or not src.exists():
                        renamed_src = self._resolve_movie_renamed_source_path(
                            ...
                            task_id=task_key,
                            task_name=task_name,
                        ) if (task_key or task_name) else None
